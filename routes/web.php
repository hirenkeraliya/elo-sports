...
// live stream
    ...
    Route::get('/streams/{id}', 'App\Http\Controllers\StreamController@index');
    ...
    Route::get('/my_bettings',[\App\Http\Controllers\MyBetsController::class, 'getMyBettingList']);    
    ...
    Route::get('/my_transcation',[\App\Http\Controllers\MyBetsController::class, 'getMyTransactionList']);    
