{{-- Page Name: Twitch Streams Report
Developed on :2023/03/24
Updated on :2023/03/24
Objective : this page will display all the live stream report of twich bet  how many streas bets total bets total vig amount streamer fee and profit
...
@section('title', 'Twitch Stream Reports ')
@section('css')
<style>
    table .dropdown {
        background: #f49e3f;
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-sm-9">
                                    <h3 class="card-title">Twitch Streams Report</h3>
                                </div>
                                <div class="col-sm-3">
...
$('#reservation').on('apply.daterangepicker', function(ev, picker) {
    ...
    var date = {
      ...
      var url =baseUrl+'/twitch-report/?start_date='+picker.startDate.format('MMMM D, YYYY')+'&end_date='+picker.endDate.format('MMMM D, YYYY');
