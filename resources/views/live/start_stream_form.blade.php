<!--
This allow to user start new elo stream. User need to add stream name , Description , Thumbnail
-->
@extends('master')
@section('css')
<style>
...
@section('content')
    ...
    @if(isset($livestream) && $livestream->status != 'stopped')
        ...
        <p class="text-light">Stream Server: <b>rtmp:{{ env('RMPT_SERVER')}}/show</b></p>
        <!--<p class="text-light">Stream Key: <b>{{ $livestream->stream_id }}</b></p>-->
        <p class="text-light">Stream Url: <b>
    ...
    @else
        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <form action="{{ route('stream.form.submit') }}" method="post" enctype="multipart/form-data" style="background-color: darkorchid;padding: 82px 36px;">
            ...
            <div class="col-sm-4">
                ...
                <p class="text-light">
                    ...
                    box.<br>
                    <br>
                    4. Sources _> Click + Sign -> Select your source from the given dropdown.<br>
                    <br>
